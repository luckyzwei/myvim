...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "\# author: zhaowei") 
        ...
        call append(line(".")+2, " *@author     zhaowei 30112737@qq.com ") 
        call append(line(".")+3, " *@date "     .strftime("      %c")) 
        call append(line(".")+4, " *@id         $Id$") 
        call append(line(".")+5, " *@copyright  Copyright (c) 2013 xcky Inc. All Rights Reserved.  ") 
        call append(line(".")+6, " ************************************************************************/") 
        call append(line(".")+7, "")
    endif
    if &filetype == 'cpp'
...
set tags=/data/icaruszhao/ninjia_prj/trunk/tags
cs add /data/icaruszhao/ninjia_prj/trunk/cscope.out
"set paste
"
let g:LookupFile_TagExpr='"/data/icaruszhao/ninjia_prj/trunk/filenametags"'
